package com.paywithease.business.customer.application;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.paywithease.business.customer.domain.Customer;
import com.paywithease.business.customer.domain.MobileNumber;
import com.paywithease.business.customer.infrastructure.CustomerContactRepository;
import com.paywithease.business.customer.infrastructure.CustomerRepository;
...
public class CustomerService {
  ...
  public Optional<Customer> searchByMobile(String rawMobile) {
    String tenantId = TenantContext.requireTenantId();
    if (!MobileNumber.isValid(rawMobile)) return Optional.empty();
  ...
  public Customer get(String id) {
    ...
    if (!customer.getTenantId().equals(tenantId)) throw ApiException.notFound("Customer");
    return customer;
  }
