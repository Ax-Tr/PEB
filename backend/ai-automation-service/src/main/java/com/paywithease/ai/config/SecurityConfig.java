package com.paywithease.ai.config;
 ...
 * layer via {@code TenantContext}. AI governance decisions (accept/reject a suggestion,
 * acknowledge/dismiss an anomaly) add {@code @PreAuthorize} method security on top of the base
