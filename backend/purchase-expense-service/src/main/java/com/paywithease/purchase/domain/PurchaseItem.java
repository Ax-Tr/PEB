...
/**
 * A single line on a purchase bill with its computed input GST split. Amounts are integer paise.
 */
@Entity
...
public class PurchaseItem {
  ...
  @JdbcTypeCode(SqlTypes.CHAR)
  @Column(name = "purchase_bill_id", length = 26, nullable = false, columnDefinition = "char(26)")
