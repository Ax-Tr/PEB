 ...
 * PAN, 1 entity code, fixed 'Z', 1 checksum char. The checksum uses the official GSTN algorithm
 * (base-36, alternating factor from the right).
 */
public final class Gstin {
  ...
  /** The embedded state code (first two digits) — used as the default place of supply. */
  public String stateCode() {
    return value.substring(0, 2);
  }

  /** The embedded PAN (characters 3–12). */
  public String pan() {
